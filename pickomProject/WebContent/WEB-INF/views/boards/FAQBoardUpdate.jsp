...
<body>
	...
	<jsp:include page="../common/header.jsp" />
		...
		<div class="container my-5 shadow p-3 mb-5 bg-white rounded">
			...
			<form action="${contextPath}/FAQBoardDML/update" method="post" 
				...
				<div class="form-inline mb-2">
					...
					<input type="text" class="form-control" id="boardTitle" name="boardTitle" size="70" value="${board.faqTitle}">
				</div>
				...
				<div class="form-inline mb-2">
					...
					<h5 class="my-0" id="today">${board.faqDate }</h5>
				</div>
				...
				<div class="form-group">
					...
					<textarea class="form-control" id="boardContent" name="boardContent" rows="15" style="resize: none;">${board.faqContent }</textarea>
				</div>
				...
				<input type="hidden" name="boardNo" value="${board.faqNo}">
